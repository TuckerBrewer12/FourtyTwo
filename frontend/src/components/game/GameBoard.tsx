        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {/* West player */}
              <div style={{ display: 'flex', alignItems: 'center', paddingRight: isMobile ? '.25rem' : '.5rem' }}>
              ...
              {/* East player */}
              <div style={{ display: 'flex', alignItems: 'center', paddingLeft: isMobile ? '.25rem' : '.5rem' }}>
